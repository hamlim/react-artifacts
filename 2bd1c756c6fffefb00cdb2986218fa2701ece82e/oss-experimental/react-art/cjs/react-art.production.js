...
function updateReducerImpl(hook, current, reducer) {
  ...
  if (null === baseQueue) hook.memoizedState = pendingQueue;
    ...
    var newBaseQueueFirst = (baseFirst = null),
      ...
      update = current,
      didReadFromEntangledAsyncAction$18 = !1;
    do {
      ...
      if (
        ...
        if (0 === revertLane)
          null !== newBaseQueueLast &&
            ...
            updateLane === currentEntangledLane &&
              (didReadFromEntangledAsyncAction$18 = !0);
    ...
    if (
      ...
      ((didReceiveUpdate = !0),
      didReadFromEntangledAsyncAction$18 &&
...
function runActionStateAction(actionQueue, node) {
  ...
  if (node.isTransition) {
    ...
    try {
      ...
      onActionError(actionQueue, node, error$22);
    }
}
          ...
          if (0 !== (updatedLanes.subtreeFlags & 1028) && null !== child)
            ...
            b: for (; null !== nextEffect; ) {
              ...
              switch (previouslyPendingLanes.tag) {
                case 0:
                  if (0 !== (flags & 4)) {
                    var updateQueue = previouslyPendingLanes.updateQueue,
                      eventPayloads =
...
var internals$jscomp$inline_1400 = {
  bundleType: 0,
  version: "19.1.0-experimental-2bd1c756-20241218",
...
exports.Text = Text;
exports.version = "19.1.0-experimental-2bd1c756-20241218";
