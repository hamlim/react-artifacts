...
"production" !== process.env.NODE_ENV &&
  (function () {
      ...
      if (null === current) {
        if (isHydrating) {
          ...
          if (
            ...
            return (
              isSuspenseInstanceFallback(JSCompiler_object_inline_message_2316)
    ...
    (function () {
      ...
      if ("19.0.0-rc-16d2bbbd-20241203" !== isomorphicReactPackageVersion)
        throw Error(
          'Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' +
            (isomorphicReactPackageVersion +
              "\n  - react-dom:  19.0.0-rc-16d2bbbd-20241203\nLearn more: https://react.dev/warnings/version-mismatch")
        );
    })();
    ("function" === typeof Map &&
      null != Map.prototype &&
