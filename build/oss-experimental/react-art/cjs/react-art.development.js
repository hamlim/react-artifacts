...
"production" !== process.env.NODE_ENV &&
  (function () {
      ...
      JSCompiler_temp
        ? 0 > blockingUpdateTime &&
          ...
          (blockingEventIsRepeat =
            -1.1 === blockingEventTime && null === blockingEventType),
        ...
        : 0 !== (lane & 4194176) &&
          ...
          0 > transitionStartTime &&
            ((transitionEventIsRepeat =
              -1.1 === transitionEventTime && null === transitionEventType),
        ...
        if (exitStatus === RootInProgress) {
          ...
          if (exitStatus === RootErrored) {
            ...
            root.errorRecoveryDisabledLanes & lanesThatJustErrored
              ? (yieldDuration = 0)
              : ((yieldDuration = root.pendingLanes & -536870913),
                (yieldDuration =
                  0 !== yieldDuration
                    ? yieldDuration
                    : yieldDuration & 536870912
                      ? 536870912
                      : 0));
            if (0 !== yieldDuration) {
              setCurrentTrackFromLanes(lanes);
              ...
              a: {
                ...
                yieldDuration = renderRootSync(startTime, yieldDuration, !1);
          ...
          a: {
            yieldDuration = root;
            forceSync = exitStatus;
            exitStatus = yieldEndTime;
            yieldEndTime = lanes;
            lanes = startTime;
            switch (forceSync) {
              case RootInProgress:
              ...
              case RootSuspendedWithDelay:
                if ((yieldEndTime & 4194176) !== yieldEndTime) break;
              case RootSuspendedAtTheShell:
                setCurrentTrackFromLanes(yieldEndTime);
                forceSync = renderStartTime;
                startTime = lanes;
                supportsUserTiming &&
                  ((reusableLaneDevToolDetails.color = "primary-dark"),
                  (reusableLaneOptions.start = forceSync),
                  (reusableLaneOptions.end = startTime),
                  performance.measure("Prewarm", reusableLaneOptions));
                finalizeRender(yieldEndTime, lanes);
                forceSync = yieldEndTime;
                0 !== (forceSync & 3) || 0 !== (forceSync & 60)
                  ? (blockingSuspendedTime = lanes)
                  : 0 !== (forceSync & 4194176) &&
                    (transitionSuspendedTime = lanes);
                markRootSuspended(
                  yieldDuration,
                  yieldEndTime,
                  workInProgressDeferredLane,
            ...
            yieldDuration.finishedWork = exitStatus;
            yieldDuration.finishedLanes = yieldEndTime;
            if (null !== ReactSharedInternals.actQueue) {
              yieldEndTime = yieldDuration;
              startTime = workInProgressRootRecoverableErrors;
              yieldDuration = workInProgressTransitions;
              ...
              if (
                (yieldEndTime & 62914560) === yieldEndTime &&
                ((startTime =
                ...
                if (0 !== getNextLanes(yieldDuration, 0)) break a;
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.0.0-experimental-c11c9510-20241120",
        rendererPackageName: "react-art",
        currentDispatcherRef: ReactSharedInternals,
        findFiberByHostInstance: getInstanceFromNode,
        reconcilerVersion: "19.0.0-experimental-c11c9510-20241120"
      };
