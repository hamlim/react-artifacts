...
if ("19.1.0-canary-a9bbe346-20241219" !== isomorphicReactPackageVersion)
  throw Error(
    'Incompatible React versions: The "react" and "react-native-renderer" packages must have the exact same version. Instead got:\n  - react:                  ' +
      (isomorphicReactPackageVersion +
        "\n  - react-native-renderer:  19.1.0-canary-a9bbe346-20241219\nLearn more: https://react.dev/warnings/version-mismatch")
  );
if (
  "function" !==
...
var roots = new Map(),
  internals$jscomp$inline_1303 = {
    bundleType: 0,
    version: "19.1.0-canary-a9bbe346-20241219",
    rendererPackageName: "react-native-renderer",
    currentDispatcherRef: ReactSharedInternals,
    reconcilerVersion: "19.1.0-canary-a9bbe346-20241219"
  };
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_1607 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_1607.isDisabled &&
    hook$jscomp$inline_1607.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_1607.inject(
        internals$jscomp$inline_1303
      )),
        (injectedHook = hook$jscomp$inline_1607);
    } catch (err) {}
}
