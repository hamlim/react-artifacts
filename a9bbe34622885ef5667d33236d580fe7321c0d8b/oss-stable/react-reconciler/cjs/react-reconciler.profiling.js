  ...
  function resolveClassComponentProps(Component, baseProps) {
    ...
    if ((Component = Component.defaultProps)) {
      ...
      for (var propName$58 in Component)
        void 0 === newProps[propName$58] &&
          (newProps[propName$58] = Component[propName$58]);
    }
    return newProps;
  }
    ...
    switch (workInProgress.tag) {
      ...
      case 13:
        ...
        if (renderLanes) {
          ...
          cache$119 !== nextResource && (newProps.flags |= 2048);
        }
        renderLanes !== current &&
          renderLanes &&
      ...
      case 19:
        ...
        cache$119 = nextResource.rendering;
        if (null === cache$119)
