...
"production" !== process.env.NODE_ENV &&
  (function () {
      ...
      try {
        ...
        if (null !== finishedWork) {
          ...
          if (0 !== (finishedWork.subtreeFlags & 15990) || rootHasEffect) {
            var prevTransition = ReactSharedInternals.T;
            ReactSharedInternals.T = null;
            rootHasEffect = currentUpdatePriority;
            currentUpdatePriority = DiscreteEventPriority;
                      ...
                      if (0 !== (flags & 4)) {
                        ...
                        if (null !== eventPayloads)
                          for (
                            ...
                            suspendedRetryLanes < eventPayloads.length;
                            suspendedRetryLanes++
                          ) {
                            var _eventPayloads$ii =
                              eventPayloads[suspendedRetryLanes];
            ...
            currentUpdatePriority = rootHasEffect;
            ReactSharedInternals.T = prevTransition;
    ...
    (function () {
      var internals = {
        bundleType: 1,
        version: "19.1.0-experimental-a9bbe346-20241219",
    ...
    exports.Text = Text;
    exports.version = "19.1.0-experimental-a9bbe346-20241219";
    "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ &&
      "function" ===
