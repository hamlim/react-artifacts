      ...
      if (null === current) {
        if (isHydrating) {
          ...
          if (
            ...
            return (
              isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2326)
        ...
        if (didSuspend)
          ...
          "POSTPONE" !== JSCompiler_object_inline_digest_2326 &&
            ...
            (JSCompiler_object_inline_message_2325 = {
              ...
              source: null,
              stack: JSCompiler_object_inline_stack_2327
            }),
            "string" === typeof JSCompiler_object_inline_stack_2327 &&
              CapturedStacks.set(
                JSCompiler_object_inline_componentStack_2328,
                JSCompiler_object_inline_message_2325
              ),
            queueHydrationError(JSCompiler_object_inline_message_2325));
          workInProgress = retrySuspenseComponentWithoutHydrating(
            current,
            workInProgress,
            renderLanes
          ...
          if (
            ...
            (JSCompiler_object_inline_stack_2327 =
              0 !== (JSCompiler_object_inline_stack_2327 & 42)
                ? 1
