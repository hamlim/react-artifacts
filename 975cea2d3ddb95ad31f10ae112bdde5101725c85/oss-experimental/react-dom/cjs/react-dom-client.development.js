      ...
      if (null === current) {
        if (isHydrating) {
          ...
          if (
            ...
            return (
              isSuspenseInstanceFallback(JSCompiler_object_inline_digest_2321)
        ...
        if (didSuspend)
          ...
          "POSTPONE" !== JSCompiler_object_inline_digest_2321 &&
            ...
            (JSCompiler_object_inline_message_2320 = {
              ...
              source: null,
              stack: JSCompiler_object_inline_stack_2322
            }),
            "string" === typeof JSCompiler_object_inline_stack_2322 &&
              CapturedStacks.set(
                JSCompiler_object_inline_componentStack_2323,
                JSCompiler_object_inline_message_2320
              ),
            queueHydrationError(JSCompiler_object_inline_message_2320));
          workInProgress = retrySuspenseComponentWithoutHydrating(
            current,
            workInProgress,
            renderLanes
