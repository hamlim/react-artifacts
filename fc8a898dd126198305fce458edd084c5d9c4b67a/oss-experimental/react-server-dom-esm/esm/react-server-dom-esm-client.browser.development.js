...
var ReactVersion = '19.1.0-experimental-fc8a898d-20241226';
    ...
    for (var _i5 = debugInfo.length - 1; _i5 >= 0; _i5--) {
      ...
      if (typeof _info2.name === 'string' && _i5 > 0) {
        ...
        if (typeof _startTimeInfo.time === 'number') {
          ...
          logComponentRender(componentInfo, trackIdx, _startTime, endTime, childrenEndTime, response._rootEnvironmentName); // Track the root most component of the result for deduping logging.
