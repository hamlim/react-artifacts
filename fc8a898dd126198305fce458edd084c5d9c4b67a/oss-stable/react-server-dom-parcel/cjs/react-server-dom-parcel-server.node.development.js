  ...
  (function () {
    ...
    exports.decodeReplyFromBusboy = function (busboyStream, options) {
      ...
      busboyStream.on("file", function (name, value, _ref) {
        ...
        pendingFiles++;
        var JSCompiler_object_inline_chunks_136 = [];
        value.on("data", function (chunk) {
          JSCompiler_object_inline_chunks_136.push(chunk);
        });
        value.on("end", function () {
          var blob = new Blob(JSCompiler_object_inline_chunks_136, {
            type: mimeType
          });
    ...
    exports.unstable_prerenderToNodeStream = function (model, options) {
